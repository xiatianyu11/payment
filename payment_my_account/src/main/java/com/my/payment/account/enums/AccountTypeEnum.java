package com.my.payment.account.enums;
...
public enum AccountTypeEnum {
	 ...
	 * POS代理商
	 */
	POSAGENT("POS代理商", 6, "2002"),
	/**
	 * POS商户_外部结算
	 */
	POS_OUT_SETT("POS商户_外部结算", 7, "2002");
	...
	private AccountTypeEnum(String desc, int value, String titleNo) {
		this.desc = desc;
		this.value = value;
